...
if (!$isLoggedIn) {
    die("<div class='text-center text-danger mt-5'>Please log in to view your watched movies.</div>");
}
...
<head>
  ...
  gap: 15px;
  max-width: 1500px;  /* ✅ NEW: make it wider to fit 3 cards */
  margin: 0 auto;
}


      .movie-item {
  flex: 0 0 calc(32% - 10px); /* slightly smaller */
...
<body style="background-color:#000;">
  ...
  <?php if (empty($movies)): ?>
    <p class="text-white text-center mt-5">You haven't watched any movies yet.</p>
  <?php endif; ?>
</div>
